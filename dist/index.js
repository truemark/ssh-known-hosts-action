...
exports.loadConfig = exports.requiredValues = exports.undefinedIfEmpty = exports.optionalArray = exports.optionalValues = exports.optionalJson = exports.optionalBoolean = exports.optionalNumber = exports.required = void 0;
...
function optionalValues(value, allowedValues) {
    if (!value)
        return undefined;
...
exports.optionalValues = optionalValues;
function optionalArray(value, delimiter) {
    if (!value)
        return undefined;
    return value.split(delimiter !== null && delimiter !== void 0 ? delimiter : '\n');
}
...
function requiredValues(value, allowedValues) {
    if (!allowedValues.includes(value))
        throw new Error(`Invalid value for input: ${value}`);
    return value;
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const scanHost of config.scanHosts) {
                ...
                const result = (0, execa_1.execaSync)('ssh-keyscan', ['-p', port, host]);
